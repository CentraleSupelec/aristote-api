...
{
    #[OA\Property(property: 'mediaTypes', description: 'List of media types (required only if generateMetada is true)', type: 'array', items: new OA\Items(type: 'string'), nullable: true)]
    ...
    #[OA\Property(property: 'disciplines', description: 'List of disciplines (required only if generateMetada is true)', type: 'array', items: new OA\Items(type: 'string'))]
    ...
    #[OA\Property(property: 'aiEvaluation', description: 'The name of the AI to evaluate the MCQs', type: 'string', nullable: true)]
    ...
    #[OA\Property(property: 'aiModel', description: 'AI Model to be used for enrichment (list available with ai_model_infrastructure_combinations endpoint)', type: 'string', nullable: true)]
    #[Groups(['Default'])]
    private ?string $aiModel = null;

    #[OA\Property(property: 'infrastructure', description: 'Infrastructure to be used for enrichment (list available with ai_model_infrastructure_combinations endpoint)', type: 'string', nullable: true)]
    #[Groups(['Default'])]
    private ?string $infrastructure = null;

    #[OA\Property(property: 'language', description: 'Language of the quizzes', type: 'string', nullable: true)]
    ...
    #[OA\Property(property: 'translateTo', description: 'Translate to this language', type: 'string', nullable: true)]
